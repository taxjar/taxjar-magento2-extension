...
class ProductBuilder
{
    ...
    public static function aGiftcardProduct(): ProductBuilder
    {
        $builder = self::aSimpleProduct();
        $builder->product->setName('Giftcard Product');
        $builder->product->setTypeId(Giftcard::TYPE_GIFTCARD);
        return $builder;
    }
    ...
    {
        $builder = clone $this;
        $builder::clearEavConfigAttributes();
    ...
    /**
     * This method should not be necessary, but this extension's legacy SmartCalcs
     * test setup establishes an unnecessary 'test_configurable' attribute which
     * must be removed to allow for product creation.
     *
     * @throws Exception
     */
    private static function clearEavConfigAttributes()
    {
