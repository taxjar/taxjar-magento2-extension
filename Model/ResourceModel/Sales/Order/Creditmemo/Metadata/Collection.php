...
namespace Taxjar\SalesTax\Model\ResourceModel\Sales\Order\Creditmemo\Metadata;
...
class Collection extends AbstractCollection
{
    ...
    protected $_eventPrefix = 'taxjar_salestax_creditmemo_metadata_collection';

    protected $_eventObject = 'creditmemo_metadata_collection';
